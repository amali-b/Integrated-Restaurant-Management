...
const calculateTotal = () => {
    ...
    /* ### Delivery Charge ### */
    txtDeliveryChg.value = parseFloat(250).toFixed(2);
    ...
    if (txtTotalAmount.value != 0.00) {
        ...
        let deliverycharge = parseFloat(txtDeliveryChg.value);

        let netamount = totalamount + deliverycharge;
...
const orderFormRefill = (ob, rowIndex) => {
    ...
    txtCustName.value = ob.customer_id?.firstname ? ob.customer_id.firstname : ob.customername;
    txtNumber.value = ob.customer_id?.contact_no ? ob.customer_id.contact_no : ob.customercontact;
...
const checkFormError = () => {
    ...
    /* if (order.vehicles_id == null) {
        deliveryVehicle.style.border = "2px solid red";
        errors = errors + "Please Select Delivery Vehicle.! \n";
    } */
...
const checkFormUpdate = () => {
    ...
    if (order != null && oldorder != null) {
        ...
        if (order.deliverycharge != oldorder.deliverycharge) {
            updates = updates + "Service Charge has updated from " + oldorder.deliverycharge + " \n";
        }
